...
@Entity(tableName = "matches", foreignKeys = {
        @ForeignKey(entity = Team.class, parentColumns = "tid", childColumns = "homeTeamId", onDelete = CASCADE),
        @ForeignKey(entity = Team.class, parentColumns = "tid", childColumns = "visitorId", onDelete = CASCADE)
})
